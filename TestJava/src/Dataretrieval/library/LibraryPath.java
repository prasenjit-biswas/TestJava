...
public class LibraryPath {
    ...
    ResultSet rs = null;       
    String libraryTestId = "13252698046573039";
    //String libraryISBN = "0077432428";
    try {
    	con = OracleConnection.getConnection();
		//con = MySqlConnection.getConnection();
    	
    	String finalpath = printTestPath(con, libraryTestId);
    	//String finalpath = printISBNPath(con, libraryISBN);
    	System.out.println("\nfinalpath " + finalpath);    	
	...
	private static String printTestPath(Connection con,String testID) throws Exception{
		PreparedStatement ps = null;
		ResultSet rs = null;
		Map mediaMap = null;
		ConcurrentHashMap librarydata = null;
	...
	private static String printISBNPath(Connection con,String isbn) throws Exception{
		PreparedStatement ps = null;
		ResultSet rs = null;
		Map mediaMap = null;
		ConcurrentHashMap librarydata = null;
