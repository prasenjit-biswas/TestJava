...
public class multipleChoiceQ extends Question{
	...
	public static multipleChoiceQ getQuestionMCQ (Question result, DataInputStream theInput, int format) throws Exception{
		multipleChoiceQ multipleChoiceq = null;
		try{
			multipleChoiceq = (multipleChoiceQ)Question.getQuestion(result, theInput, format);
	...
	private static void print_MultiplechoiceQ(multipleChoiceQ multipleChoiceq) {
