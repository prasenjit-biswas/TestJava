...
public class XmlUtils {
    ...
    public static String getChildText(Element parent, String childName, boolean required)
            throws Exception {
    ...
    public static Element getChildElement(Element parent, String childName, boolean required)
            throws Exception {
    ...
    public static void main(String args[]){
    	try{
    		String result = "<transaction name=\"copyx\" version=\"3\"></transaction>";
    		buildDOMTree(result);    		
    	}catch(Exception ex){
    		ex.printStackTrace();
    	}
